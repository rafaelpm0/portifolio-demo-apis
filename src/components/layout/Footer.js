    ...
    return (
        <footer className={`${styles.footer} ${classname}`}>
            ...
            <ul className={styles.list}>
                <li><a href="https://www.instagram.com/rafaelm0_/" target='_blanck'>
                    <img src={instagram} alt="Instagram" className={styles.img}/></a>
                </li>
                <li><a href="https://github.com/rafaelpm0/" target='_blanck'>
                    <img src={github} alt="Github" className={styles.img}/></a>
                </li>
                <li><a href="https://wa.me/5548998385803/" target='_blanck'>
                    <img src={wpp} alt="WhatsApp" className={styles.img}/></a>
                </li>
                <li><a href="mailto:rafaelpmedeiros00@gmail.com" target='_blanck'>
